...
// ----- 주제: 객체재질 매쉬재질 매시재질 메쉬재질 메시재질 표면재질 캔버스의 텍스쳐 택스쳐 canvas material texture
...
export default function example() {
	...
	function draw() {
		...
		// 조그만 하얀색 사각형을 그리고 애니메이션으로 움직이게 하기위해
		texContext.fillStyle = 'white';
		// texContext.fillRect(0, 100, 50, 50);
		texContext.fillRect(time * 50, 100, 50, 50);
		texContext.font = 'bold 80px sans-serif';
		texContext.fillText('Tomasjoa', 80, 270)
