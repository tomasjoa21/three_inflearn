...
// ----- 주제: 빛 라이트 광원 HemisphereLight 반구광원, dat.GUI, AxesHelper, lightHelper
...
export default function example() {
	...
	// AmbientLight는 HemisphereLight로 대체 가능하므로 여기서는 일단 주석처리
	// const ambientLight = new THREE.AmbientLight('white', 0.5);
	// scene.add(ambientLight);

	// Light (HemisphereLight는 반구광원)
	// 인수 (색상(0xffffff or 'white'), 색상2(0xffffff or 'white'), 강도(1))
